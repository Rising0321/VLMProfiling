...
from utils.io_utils import load_access_street_view, get_graph_and_images_dual, output_words
    ...
    while True:
        ...
        try:
            ...
            if args.model == 'MiniCPM':
                ...
                model_id = "/home/wangb/zhangrx/models/Phi-3-vision-128k-instruct"
                ...
                prompt = processor.tokenizer.apply_chat_template(msgs_withImage, tokenize=False, add_generation_prompt=True)
                ...
                model = "/home/wangb/zhangrx/models/InternVL2-8B"
            ...
            #     model_path = "/home/wangb/zhangrx/models/deepseek-vl-7b-chat"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="Phi3",
        choices=["MiniCPM", "GPT", "Phi3", "Internvl2", "Deepseek"],
        help="model name",
    )
